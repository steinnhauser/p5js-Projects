...
function createGUI() {
  ...
  if (!GUISet) {
    paragraph = createP("Set Mass (not yet implemented):");
    massSlider = createSlider(0, 100, 50);
    
    boundsCheckbox = createCheckbox("Bouncy Boundaries", false);
    collisionCheckbox = createCheckbox("Collision Activation (not yet implemented)", false);
